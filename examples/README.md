...
> 2026학년도 5학년 3반 2학기 과정중심평가 시스템을 만들어줘. 학생은 학생01부터 학생24까지, 교과는 국어·사회·수학·과학·영어로 하고 평가 수준은 매우잘함·잘함·보통·노력요함으로 해줘.

`education_create_assessment_tracker`가 학생명단부터 평가·제출·관찰 기록과 대시보드까지 연결된 9개 탭을 생성합니다.

### 개인정보 비노출 구조 진단

> 이 Google Sheets의 실제 셀 내용과 수식 본문은 보여주지 말고, 탭 구조·수식 함수·시트 간 의존성·깨진 수식·드롭다운·차트 구조만 점검해줘.

`sheets_inspect_workbook`은 학생 이름이나 점수를 반환하지 않고 구조 통계와 오류 셀 위치만 제공합니다.
